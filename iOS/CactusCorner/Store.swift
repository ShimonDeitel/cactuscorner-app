...
final class Store: ObservableObject {
    ...
    init() {
        let dir = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("cactuscorner", isDirectory: true)
    ...
    @discardableResult
    func add(_ item: Plant, isPro: Bool) -> Bool {
    ...
    static func seedData() -> [Plant] {
        [
            Plant(title: "Echeveria", species: "14"),
            Plant(title: "Barrel Cactus", species: "21"),
            Plant(title: "Jade Plant", species: "10")
        ]
    }
}
